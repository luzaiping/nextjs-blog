...
export function getAllPostIds() {
  ...
  // Returns an array that looks like list:
  // [
  //   {
  //     params: {
  //       id: 'ssr-ssg'
  ...
  // that look like the comment above. Each object must have the `params` key and contain
  // an object with the `id` key (because we're using `[id]` in the file name). Otherwise, 
